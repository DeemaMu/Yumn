...
class SignUpViewController: UIViewController {
    ...
    func setUpElements(){
        ...
        styleTextFields(textfield: firstNameTextField)
        styleTextFields(textfield: lastNameTextField)
        styleTextFields(textfield: idTextField)
        styleTextFields(textfield: emailTextField)
        styleTextFields(textfield: phoneTextField)
        styleTextFields(textfield: passwordTextField)
        styleTextFieldsWithPicker(textfield: dateTextField)
    ...
    */
    ...
    @objc func validateDate(textfield: UITextField){
        ...
        // Everything is fine
            ...
            // White space so that the layout is not affected; however, trim it in the validation
            dateError.text="  "
            styleTextFields(textfield: dateTextField)
    ...
    @IBAction func onPressedCont(_ sender: Any) {
        ...
        /*Auth.auth().fetchSignInMethods(forEmail: emailTextField.text!.trimmingCharacters(in: .whitespacesAndNewlines), completion: {
                (providers, error) in
                ...
                if let error = error {
                    ...
                    self.popUpTitle.text = "البريد الالكتروني مستخدم"
                    self.popUpMessage.text = "الرجاء ادخال بريد الكتروني آخر"
                }
            })
*/
...
extension UIViewController {
    ...
    self.view.addSubview(toastLabel)
    UIView.animate(withDuration: 12, delay: 0, options:
