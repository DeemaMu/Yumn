...
struct PopupAddForm: View {
    ...
    func saveData() {
        ...
        let apt = BloodAppointment(type: "blood", startTime: selectedDate, endTime: endDate, aptDate: date, hospital: Constants.UserInfo.userID, aptDuration: duration, donors: peoplePerA)
